int yield_W_RyanCuts_NOBETA(Int_t RunNumber=0){
  ...
  TCut cCuts = "H.tr.chi2>25.0 && H.tr.ndof>-8.0 && H.tr.ndof<8.0 && H.cal.etotnorm>0.6 && H.tr.tg_th>-0.080 && H.tr.tg_th<0.080 && H.tr.tg_ph>-0.035 && H.tr.tg_ph<0.035";
...
ofstream myfile;
  myfile.open ("eltrackEvts_RyanCuts_NOBETA", fstream::app);
  myfile << rNumber << " " << h1->Integral() <<"\n"; //write to file
  myfile.close();


//c0->Print("yield_W_"+ rNumber + ".png");
c0->Print("yield_W_RyanCuts_NOBETA_"+ rNumber + ".png");
