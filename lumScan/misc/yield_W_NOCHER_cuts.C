int yield_W_NOCHER_cuts(Int_t RunNumber=0){
  ...
  TCut cCuts = "H.tr.tg_dp>-8.5 && H.tr.tg_dp<8.5 && H.cal.etracknorm>0.7 && H.tr.tg_th>-0.09 && H.tr.tg_th<0.09 && H.tr.tg_ph>-0.055 && H.tr.tg_ph<0.055 && H.tr.tg_y>-3.5 && H.tr.tg_y<3.5";
...
ofstream myfile;
  myfile.open ("eltrackEvts_NOCHER", fstream::app);
  myfile << rNumber << " " << h1->Integral() << "\n";
  myfile.close();


//c0->Print("yield_W_"+ rNumber + ".png");
c0->Print("yield_W_NOCHER_Cuts_"+ rNumber + ".png");
