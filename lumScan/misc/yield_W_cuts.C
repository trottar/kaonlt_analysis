int yield_W_cuts(Int_t RunNumber=0){
  ...
  if(RunNumber == 0) {
   ...
   const char* ROOTFileNamePattern = "$HOME/ResearchNP/HcanaFiles/ROOTfiles/hms_replay_production_all_%d_-1.root";
  ...
  /*TCut cCuts = "H.cer.npeSum>0.5 && H.tr.tg_dp>-8.5 && H.tr.tg_dp<8.5 && H.cal.etracknorm>0.7 && H.tr.tg_th>-0.09 && H.tr.tg_th<0.09 && H.tr.tg_ph>-0.055 && H.tr.tg_ph<0.055 && H.tr.tg_y>-3.5 && H.tr.tg_y<3.5";*/

//Mark's Cuts
  TCut cCuts = "H.cer.npeSum>2. && H.cal.etotnorm>0.7 && H.cal.etotnorm<1.5";

 TH1F *h1 = new TH1F("h1","W Cuts for " + rNumber, 200, -20, 20);
 TCanvas *c0 = new TCanvas("c0","c0");
 
 //T->Draw("H.cer.npeSum>>h1");
...
ofstream myfile;
  myfile.open ("eltrackEvts", fstream::app);
