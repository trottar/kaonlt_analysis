...
gStyle->SetPalette(1,0);
 ...
 gStyle->SetPadLeftMargin(0.12);
   TString inputroot;
   inputroot=basename+".root";
   TString outputhist;
   outputhist=basename+"_recon.root";
   TString outputpdf;
 outputpdf=basename+"_recon.pdf";
...
cfpdd->Divide(1,4);
 ...
 hDeltadiffvsDeltaini->SetTitle(";Init Delta; Fitted Sigma of Delta diff (%)");
 hDeltadiffvsDeltaini->Draw();
 HList.Add(hDeltadiffvsDeltaini);
 cfpdd->cd(3);
 hDeltadiffvsDeltaini->SetTitle(";Init Delta; Fitted Mean of Delta diff (% )");
 hDeltadiffvsDeltaini->Draw();
 HList.Add(hDeltadiffvsDeltaini);
cfpdd->cd(4);
 TProfile *hDeltadiffvsDeltaini_px =  hDeltadiffvsDeltaini->ProfileX("hDeltadiffvsDeltaini_px",1,-1,"s");//
...
cfpdd->Print(outputpdf + "(");
  //
TCanvas *cfpytar = new TCanvas("cfpytar","Ytar diff ",1400,900);
 gStyle->SetOptTitle(1);
 TPaveLabel *title2 = new TPaveLabel(.25,.85,.35,.99,htitle,"ndc");
cfpytar->Divide(1,4);
 cfpytar->cd(1);
 ...
 hYtardiffvsYtarini->SetTitle(";Init Ytar; Fitted Sigma of Ytar diff (cm");
 hYtardiffvsYtarini->Draw();
 HList.Add(hYtardiffvsYtarini);
 cfpytar->cd(3);
 hYtardiffvsYtarini->SetTitle(";Init Ytar; Fitted Mean of Ytar diff (cm");
 hYtardiffvsYtarini->Draw();
 HList.Add(hYtardiffvsYtarini);
cfpytar->cd(4);
 TProfile *hYtardiffvsYtarini_px =  hYtardiffvsYtarini->ProfileX("hYtardiffvsYtarini_px",1,-1,"s");//
 hYtardiffvsYtarini_px->SetTitle(";Init Ytar; Mean +/- RMS of Ytar diff (% )");
 hYtardiffvsYtarini_px->Draw();
 HList.Add(hYtardiffvsYtarini_px);
cfpytar->Print(outputpdf);
//
   //
TCanvas *cfpyptar = new TCanvas("cfpyptar","Yptar diff ",1400,900);
 gStyle->SetOptTitle(1);
 TPaveLabel *title3 = new TPaveLabel(.25,.85,.35,.99,htitle,"ndc");
cfpyptar->Divide(1,4);
 cfpyptar->cd(1);
 ...
 hYptardiffvsYptarini->SetTitle(";Init Yptar; Fitted Sigma of Yptar diff (mr)");
 hYptardiffvsYptarini->Draw();
 HList.Add(hYptardiffvsYptarini);
 cfpyptar->cd(3);
 hYptardiffvsYptarini->SetTitle(";Init Yptar; Fitted Mean of Yptar diff (mr)");
 hYptardiffvsYptarini->Draw();
 HList.Add(hYptardiffvsYptarini);
cfpyptar->cd(4);
 TProfile *hYptardiffvsYptarini_px =  hYptardiffvsYptarini->ProfileX("hYptardiffvsYptarini_px",1,-1,"s");//
...
cfpyptar->Print(outputpdf);
//
   //
TCanvas *cfpxptar = new TCanvas("cfpxptar","Xptar diff ",1400,900);
 gStyle->SetOptTitle(1);
 TPaveLabel *title4 = new TPaveLabel(.25,.85,.35,.99,htitle,"ndc");
cfpxptar->Divide(1,4);
 cfpxptar->cd(1);
 ...
 hXptardiffvsXptarini->SetTitle(";Init Xptar; Fitted Sigma of Xptar diff (mr)");
 hXptardiffvsXptarini->Draw();
 HList.Add(hXptardiffvsXptarini);
 cfpxptar->cd(3);
 hXptardiffvsXptarini->SetTitle(";Init Xptar; Fitted Mean of Xptar diff (mr)");
 hXptardiffvsXptarini->Draw();
 HList.Add(hXptardiffvsXptarini);
cfpxptar->cd(4);
 TProfile *hXptardiffvsXptarini_px =  hXptardiffvsXptarini->ProfileX("hXptardiffvsXptarini_px",1,-1,"s");//
...
cfpxptar->Print(outputpdf);
//
TCanvas *cfpd = new TCanvas("cfpd","Diff",1400,900);
 gStyle->SetOptTitle(1);
 TPaveLabel *title5 = new TPaveLabel(.15,.85,.35,.99,htitle,"ndc");
cfpd->Divide(2,2);
 cfpd->cd(1);
 hDeltadiff->Draw();
