...
void plot_resol(TString basename="") {
 ...
 gStyle->SetPadLeftMargin(0.12);
   ...
   TString outputhist;
   outputhist=basename+"_resol.root";
   TString outputpdf;
   outputpdf=basename+"_resol.pdf";
...
TCanvas *cxptar = new TCanvas("cxptar",xlabel,1024,768);
cxptar->Divide(4,4);
cxptar->cd(8);
difxptar->Draw();
difxptar->Fit("gaus");
...
//
 ...
 TCanvas *cyptar = new TCanvas("cyptar",ylabel,1024,768);
cyptar->Divide(4,4);
cyptar->cd(8);
difyptar->Draw();
difyptar->Fit("gaus");
...
//
   ...
   TCanvas *cdelta = new TCanvas("cdelta",ylabel,1024,768);
cdelta->Divide(4,4);
cdelta->cd(8);
difdelta->Draw();
difdelta->Fit("gaus");
...
//
 ...
 TCanvas *cytar = new TCanvas("cytar",ylabel,1024,768);
cytar->Divide(4,4);
cytar->cd(8);
difytar->Draw();
difytar->Fit("gaus");
