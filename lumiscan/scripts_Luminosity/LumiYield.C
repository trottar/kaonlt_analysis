...
Bool_t LumiYield::Process(Long64_t entry)
{
  ...
  //   {
  if((*T_coin_pTRIG1_ROC2_tdcTime > 150 && *T_coin_pTRIG1_ROC2_tdcTime<=240.0)
     && *T_coin_pEDTM_tdcTime>580.0 && *T_coin_pEDTM_tdcTime<615.0 
							    ) // Event was an SHMS Single
    {
  ...
  //   {
  if((*T_coin_pTRIG3_ROC1_tdcTime > 285 && *T_coin_pTRIG3_ROC1_tdcTime<325.0)    
     && *T_coin_pEDTM_tdcTime>580.0 && *T_coin_pEDTM_tdcTime<615.0 //with TDC cuts
     ) // Event was an HMS Single
    {
