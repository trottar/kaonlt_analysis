...
! from Steve Rock
      real e0,p,thdeg,rl,sigpip

      e0=10.90
      P=3.725
      thdeg=24.18
!      rl=2.35 ! for 20cm target
!      rl=1.77 ! for 15cm target
      rl=1.18 ! for 10cm target
!      rl=0.944 ! for 8cm target
!      rl=0.47 ! for 4cm target


! for 8-cm LH2 target (8cm*0.0723g/cm3)/X0, where X0=61.28g/cm2
! then divide by 2

      CALL WISER_ALL_SIG (E0,P,THDEG,rl,5,SIGPIP)
      write(6,'(1x,e12.4)') sigpip
